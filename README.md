...
- A token is like a secret password given by the server to the client. It's used to identify the client and see what permissions it has.


 - [X] What steps can you take in your web apps to keep your data secure?
- Use protected routes and tokens to limit access.


 - [X] Describe how web servers work.
- A web server stores code to be shared upon request.


 - [X] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
- Put is Update, Delete is ...Delete. There's also Post to Create and Get to Read.
